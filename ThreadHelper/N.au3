...
Global $KERNEL32DLL = "kernel32.dll"
Global $__nMod = DllCall($KERNEL32DLL, 'handle', 'LoadLibraryW', 'wstr', @AutoItX64 ? 'N64.dll' : 'N.dll')[0]

Global $__nPfn_Global 	= __n_GetProc(101)
Global $__nPfn_Local 	= __n_GetProc(102)
Global $__nPfn_Run 		= __n_GetProc(103)
Global $__nPfn_IsMain 	= __n_GetProc(104)
Global $__nPfn_PrepMain 	= __n_GetProc(105)
Global $__nPfn_PrepSub 	= __n_GetProc(106)
Global $__nPfn_Wait 		= __n_GetProc(107)
Global $__nPfn_WaitAll 	= __n_GetProc(108)
...
func NRun($fn, $o = null)
	Local $IDId = DllCallAddress('dword', $__nPfn_Run, 'str', $fn, 'ptr',  $o)[0]
	return $IDId
endfunc
...
Func NTerminate($ThreadID)
	Local $hThread = _ThreadOpen($ThreadID,0x0001)
